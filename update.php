   ...
   if (!empty($image)) {
      if ($image_size > 2000000) {
         ...
         if ($prev_image != '' and $prev_image != $rename) {
            unlink('BackEnd/uploaded_files/' . $prev_image);
         }
   ...
   <section class="form-container" style="min-height: calc(100vh - 19rem);">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <div class="flex">
            <div class="col">
               <p>your name</p>
               <input type="text" name="name" placeholder="<?= $user['name']; ?>" maxlength="100" class="box">
               <p>your email</p>
               <input type="email" name="email" placeholder="<?= $user['email']; ?>" maxlength="100" class="box">
               <p>update pic</p>
